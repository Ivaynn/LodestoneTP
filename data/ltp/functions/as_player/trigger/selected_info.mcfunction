...
execute if score TriggerInfo ltp.options matches 1 if data storage ltp:ltp tmp.data.LodestonePos.X run tellraw @s [" ",{"text":"Coordinates:  ","color":"gray"},{"color":"white","nbt":"tmp.data.LodestonePos.X","storage":"ltp:ltp"},{"text":", ","color":"gray"},{"color":"white","nbt":"tmp.data.LodestonePos.Y","storage":"ltp:ltp"},{"text":", ","color":"gray"},{"color":"white","nbt":"tmp.data.LodestonePos.Z","storage":"ltp:ltp"},{"text":"\n Dimension:     ","color":"gray"},{"color":"white","nbt":"tmp.data.LodestoneDimension","storage":"ltp:ltp"}]
